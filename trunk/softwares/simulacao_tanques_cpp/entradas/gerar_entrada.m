% Arquivo para gerar pontos de entrada para treinamento da RNA do trabalho
% final de Redes Neurais do mestrado.
...
tempo_seg = 60 * 30; % 30 minutos

% Periodo de amostragem em segundos
periodo_amost = 0.1;

% Tempo final em milisegundos
tempo_final_milisegundos = tempo_seg / periodo_amost;

% Vetor de tempo
t = 0.0 : periodo_amost : tempo_final_milisegundos - periodo_amost;
...
% Porcentagem de ruido de vazamento
...
% Orificios de saida
orif_saida_t1 = 0.178139348120214; % Orificio medio
orif_saida_t2 = 0.178139348120214; % Orificio medio
...
M = [ t', ...
      ...
      ones( num_amostras, 1 ) * porcent_ruido_vazamento_t1, ...
      ones( num_amostras, 1 ) * porcent_ruido_vazamento_t2, ...
      ones( num_amostras, 1 ) * constante_bomba_t1, ...
      ones( num_amostras, 1 ) * constante_bomba_t2, ...
      ones( num_amostras, 1 ) * orif_saida_t1, ...
      ones( num_amostras, 1 ) * orif_saida_t2, ...
...
nome_arq_saida = strcat( 'config_', ...
                         strcat( num2str( num_amostras ), '.dat' ) );
