...
for i = 1 : length( falhas )
    ...
    pasta_saidas = strcat( '../simulacao_tanques_cpp/saidas/', falha, '/' );
    ...
    % CONTINUAR AQUI ::::::::::::::::::::::::::::::::::::::::::::::::::::::
    % PENSAR COMO EXIBIR OS RESIDUOS (olhar dissertacao de marcela)
    %
    % PENSAR COMO EXIBIR A DETECCAO DA FALHA
    %
    % VER SE NAO EH MELHOR GERAR UMA FALHA E VOLTAR PARA O ESTADO NORMAL
    % PARA GERAR A FALHA SEGUINTE

%     % Determinando o nome do arquivo final e chamando o metodo para 
%     % gerar a saida
%     nome_final = strcat( nome_arq_sem_ext, '_qualif' );
% 
