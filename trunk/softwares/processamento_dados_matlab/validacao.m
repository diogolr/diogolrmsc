...
pasta_valid = '..\saidas\20_min_FSeDO_0a5\';

% pasta_rnas = input( 'Pasta dos arquivos das redes treinadas: ' );
pasta_rnas = '..\..\qualificacao\dados_matlab\deteccao\FSeDO\';
        ...
        for n = 1 : size( nco, 2 )
            ...
            for t = 1 : n_treinamentos
                ...
                if gerar_planilha
                    ...
                    % validacao
                    if v >= 2
                        linha = linha + ( v - 1 ) * ( n_treinamentos + 2 );
                    end
