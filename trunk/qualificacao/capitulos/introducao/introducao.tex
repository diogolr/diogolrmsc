...
% ------------------------------------------------------------------------------
\section{Automação e supervisão de processos}
...
De maneira complementar ao que foi exibido pela Fig.
\ref{fig:arvore_diagnostico}, \citeasnoun{venkatasu:2003a} subdivide os
...
\centering
    ...
    {
        \includegraphics{imgs/introducao/eps/arvore_venkatsu_quant}
        \label{fig:arvore_venkatsu_quant}
    }
    \subfigure[Algoritmos baseados em Análise Qualitativa]
    {
        \includegraphics{imgs/introducao/eps/arvore_venkatsu_qual}
    }
    \subfigure[Algoritmos baseados em Histórico do Processo]
    {
        \includegraphics{imgs/introducao/eps/arvore_venkatsu_hist}
        \label{fig:arvore_venkatsu_hist}
    }
