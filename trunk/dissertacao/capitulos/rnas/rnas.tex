...
médio consideravelmente alto. Segundo \citeasnoun{arruda:2003}, existe uma ordem
...
\citeasnoun{norgaard:2000}, devido a estas características, o modelo NNARX é um
dos mais utilizados quando o sistema a ser modelado é determinístico ou o nível
de ruído não é significativo.

\Glossary{BIBO}{\it Bounded Input, Bounde Output}
...
% ------------------------------------------------------------------------------
\section{RNAs para detecção e diagnóstico de falhas}
\end{comment}
