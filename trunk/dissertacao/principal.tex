...
\input{capitulos/rnas/rnas}
\input{capitulos/detec_diag/detec_diag}
\input{capitulos/sistema/sistema}
\input{capitulos/resultados/resultados}
\input{capitulos/conclusoes/conclusoes}

% Apêndices --------------------------------------------------------------------
\appendix
\input{apendices/formatacao_xml/formatacao_xml}
