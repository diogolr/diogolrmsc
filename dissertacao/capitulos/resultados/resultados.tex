...
% ------------------------------------------------------------------------------
\subsection{Redes para a identificação do modelo}
...
% ------------------------------------------------------------------------------
\subsection{Redes para a detecção/diagnóstico de falhas}
...
\cellcolor[gray]{0.85}2 &
\cellcolor[gray]{0.85}23492 & 
\cellcolor[gray]{0.85}203 & 
\cellcolor[gray]{0.85}305 & 
\cellcolor[gray]{0.85}2,12\%\\
\hline
\multirow{3}{*}{FSeDO} &
2 & 16 & 3 & 23872 & 4 & 124 & 0,53\%\\
\cline{2-8}
...
\cellcolor[gray]{0.85}23890 & 
\cellcolor[gray]{0.85}9 & 
\cellcolor[gray]{0.85}101 & 
\cellcolor[gray]{0.85}0,46\%\\
\hline
\multirow{3}{*}{FSeSR} &
2 & 8 & 2 & 23306 & 201 & 493 & 2,89\%\\
\cline{2-8}
...
\cellcolor[gray]{0.85}325 & 
\cellcolor[gray]{0.85}358 & 
...
\cellcolor[gray]{0.85}8 & 
\cellcolor[gray]{0.85}3 & 
\cellcolor[gray]{0.85}20710 & 
\cellcolor[gray]{0.85}1627 & 
...
\hline
\multirow{3}{*}{FADO} & 2 & 12 & 2 & 22828 & 612 & 560 & 4,88\%\\
\cline{2-8}
...
\cellcolor[gray]{0.85}28 & 
\cellcolor[gray]{0.85}3 & 
\cellcolor[gray]{0.85}23075 & 
\cellcolor[gray]{0.85}636 & 
...
\cellcolor[gray]{0.85}14153 & 
\cellcolor[gray]{0.85}3407 & 
\cellcolor[gray]{0.85}6440 & 
...
\cellcolor[gray]{0.85}8 & 
\cellcolor[gray]{0.85}5 & 
\cellcolor[gray]{0.85}20765 & 
\cellcolor[gray]{0.85}1551 & 
...
\cellcolor[gray]{0.85}2 & 
\cellcolor[gray]{0.85}18 & 
\cellcolor[gray]{0.85}0,083\%\\
\hline
\multirow{3}{*}{FSiVzT} &
2 & 16 & 6 & 23623 & 174 & 203 & 1,57\%\\
\cline{2-8}
...
\cellcolor[gray]{0.85}1 & 
\cellcolor[gray]{0.85}23774 & 
\cellcolor[gray]{0.85}74 & 
\cellcolor[gray]{0.85}152 & 
...
\cellcolor[gray]{0.85}8 & 
\cellcolor[gray]{0.85}3 & 
\cellcolor[gray]{0.85}22465 & 
\cellcolor[gray]{0.85}437 & 
\cellcolor[gray]{0.85}1098 & 
...
\cellcolor[gray]{0.85}20 & 
\cellcolor[gray]{0.85}2 & 
\cellcolor[gray]{0.85}20906 & 
\cellcolor[gray]{0.85}1980 & 
\cellcolor[gray]{0.85}1114 & 
...
Vale destacar que há uma nítida diferença entre a curva denominada ``Saída
$T_i$'', a qual representa a saída efetiva do sensor do tanque $i$, e a curva da
saída real do sistema, denominada ``Saída real $T_i$''. Essa diferença deverá
ser implicitamente interpretada nas demais falhas do sensor.

Assim sendo, quando o valor lido pelos sensores for de 24\ cm, o tanque estará
