...
for N = 1 : 4
    ...
    % possibilidades: variar somente a referencia do tanque 1, variar 
    % somente a referencia do tanque 2 ou ainda variar a referencia dos 2 
    % tanques. Entao essa probabilidade sera de 33.33% de chance para cada 
    % uma dessas variacoes
