...
na camada oculta serão determinados posteriormente, no Cap.
\ref{cap:resultados}.  Maiores detalhes sobre cada uma das estruturas propostas
...
entrada os níveis anteriores e as tensões a serem aplicadas e gera em sua saída
